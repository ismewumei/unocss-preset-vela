...
export const bgColors: Rule[] = [
  [/^bgc-([\.\w]+)$/, ([_, word]) => ({ 'background-color': `${word}` })],
...
//vela特有属性
export const trackColors: Rule[] = [
  [/^tkc-([\.\w]+)$/, ([_, word]) => ({ 'track-color': `${word}` })],
  [/^trackc-([\.\w]+)$/, ([_, word]) => ({ 'track-color': `${word}` })],
]

export const layerColors: Rule[] = [
  [/^layerc-([\.\w]+)$/, ([_, word]) => ({ 'layer-color': `${word}` })],
  [/^lc-([\.\w]+)$/, ([_, word]) => ({ 'layer-color': `${word}` })],
]